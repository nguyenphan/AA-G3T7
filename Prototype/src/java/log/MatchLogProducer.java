...
public class MatchLogProducer implements ExceptionListener{
    ...
    String localDestinationName = "a.match";
    String foreignDestinationName = "b.match";
    String localReplyDestinationName = "a.a.match";
    String foreignReplyDestinationName = "a.b.match";
    
    //String localDestinationName = "a.match";
    //String foreignDestinationName = "b.match";
    //String localReplyDestinationName = "b.a.match";
    //String foreignReplyDestinationName = "b.b.match";
    ...
    public MatchLogProducer(){
        try {
            runConnections();
        } catch (JMSException ex) {
            Logger.getLogger(MatchLogProducer.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

    public static void main(String[] args){
            new MatchLogProducer();
    }
