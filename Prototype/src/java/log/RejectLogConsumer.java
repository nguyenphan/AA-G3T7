...
public class RejectLogConsumer implements ExceptionListener{
    ...
    String destinationName = "a.reject";
    //String destinationName = "b.reject"; 
    ...
    public RejectLogConsumer(){
        try {
            runConnections();
            
        } catch (JMSException ex) {
            Logger.getLogger(RejectLogConsumer.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    
    public static void main(String[] args){
        try {
            RejectLogConsumer listener = new RejectLogConsumer();
            ...
            while(true){
                ...
                if (tmpMessage != null) {
                    ...
                    try {
                        ...
                        String fileName = "./logs/rejected.log";
